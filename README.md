...
[?????? Release](https://github.com/Maybank01/agentrouter-desktop-releases/releases/latest)
...
??????????????`Maybank01/agentrouter-desktop/assembly/coordinated`?
??? `assembly/coordinated/adapter-source.json` ????????????????????????
??????????? npm ?????????????????

PR ? Windows ?????? NSIS???????/??/????????????????????
????????????????????? Release ????? `release.json` ????????????

???????? `release.yml`?? main ???? `coordinated`?????????????
????????????????? publish?????????????????? draft????
????? Windows ???? Authenticode ?????????????? latest?

?????? `self-hosted / Windows / X64 / agentrouter-signing`???? `windows-signing`?
???? SafeNet SignTool??????? `DSH_DESKTOP_WINDOWS_CER_FILE`?
`DSH_DESKTOP_WINDOWS_SIGNTOOL`?`DSH_DESKTOP_WINDOWS_KEY_CONTAINER` ????????
Token PIN ???? `DSH_DESKTOP_WINDOWS_TOKEN_PIN` ?? Secret ????????????
???????????????????SignPath ???????????????????????
