...
export function requiresInstalledAcceptance(paths) {
  return paths.some(path => {
    ...
    if (/^assembly\/(test\/|plugin-ci\/|coordinated-(website|public|recovery)\.mjs$|ci-scope\.mjs$|rollout\.mjs$|wait-plugin\.mjs$|mirror-verify\.mjs$|release-timeline\.mjs$|release-budgets\.json$)/.test(path)) return false
