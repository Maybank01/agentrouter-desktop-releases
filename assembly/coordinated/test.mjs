...
execFileSync(process.execPath, ['--test', ...['update-signature', 'update-routes', 'credential-recovery', 'external-navigation'].map(name => join(directory, `${name}.test.mjs`))], { cwd: source, stdio: 'inherit', windowsHide: true, timeout: 60000 })
