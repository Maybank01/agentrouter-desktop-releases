...
execFileSync(process.execPath, ['--test', join(directory, 'update-signature.test.mjs'), join(directory, 'update-routes.test.mjs')], { cwd: source, stdio: 'inherit', windowsHide: true, timeout: 60000 })
