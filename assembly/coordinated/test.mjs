...
execFileSync(process.execPath, ['--test', ...['update-signature', 'update-recovery', 'update-exit', 'update-processes', 'update-routes', 'credential-recovery', 'external-navigation', 'runtime-recovery', 'update-runtime', 'update-transport', 'update-rollout', 'update-network', 'installed-version', 'installed-process', 'install-retry'].map(name => join(directory, `${name}.test.mjs`))], { cwd: source, stdio: 'inherit', windowsHide: true, timeout: 60000 })
